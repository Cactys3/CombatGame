...
const CLARN_ALT = preload("uid://baoo0ylcktami")
const FLUUE = preload("uid://d1v8l8ulmvpo")
const FLUUE_ALT = preload("uid://4edq65ri8mb4")
const GUREL = preload("uid://d3y8ffd1nwhp4")
const GUREL_ALT = preload("uid://bd0rbr36ddu3s")
const JARRE = preload("uid://b1me3l65aoeu1")
const JARRE_ALT = preload("uid://c66r3cxhunfhe")
const KLE = preload("uid://i0ead3kcc77p")
const KLE_ALT = preload("uid://b6wvvteevjdxf")
const SCLARNK = preload("uid://bpx8cildenn6g")
const SCLARNK_ALT = preload("uid://dxpy51rg5pd6l")
## Enemy Events
const KLE_CLUSTER = preload("uid://cpbkathjul2cc")
const KLE_CLUSTER_ALT = preload("uid://3hwogmb2otk")
## Bosses
const SHLARNGUH = preload("uid://cxv2mja6rt14")
const SHLARNGUH_ALT = preload("uid://bfwl525b5ro0w")
## Events
...
func phase_four():
	...
	enemies.append(EnemySpawn.new("GUREL", GUREL, 0.15, 1))
	enemies.append(EnemySpawn.new("GUREL", GUREL_ALT, 0.05, 1))
	enemies.append(EnemySpawn.new("CLARN", CLARN, 0.15, 1))
	enemies.append(EnemySpawn.new("CLARN", CLARN_ALT, 0.05, 1))
	enemy_events.append(EnemyEventSpawn.new("KLE_CLUSTER", KLE_CLUSTER, 0.1, false, 1))
func phase_five():
...
func phase_seven():
	...
	enemies.append(EnemySpawn.new("KLE", KLE, 0.40, 1))
	enemies.append(EnemySpawn.new("KLE", KLE_ALT, 0.1, 1))
	enemies.append(EnemySpawn.new("JARRE", JARRE, 0.12, 1))
	enemies.append(EnemySpawn.new("JARRE", JARRE_ALT, 0.08, 1))
	enemy_events.append(EnemyEventSpawn.new("KLE_CLUSTER", KLE_CLUSTER, 0.5, false, 1))
	enemy_events.append(EnemyEventSpawn.new("KLE_CLUSTER", KLE_CLUSTER_ALT, 0.5, false, 1))
func phase_eight():
	print("PHASE 8 - Clarn is back!")
	generic_phase_setup(8)
	enemies.append(EnemySpawn.new("CLARN", CLARN, 0.1, 2))
	enemies.append(EnemySpawn.new("CLARN", CLARN_ALT, 0.4, 2))
func phase_nine():
	print("PHASE 9 - They're so cute!")
	generic_phase_setup(9)
	enemies.append(EnemySpawn.new("GUREL", GUREL, 0.15, 1))
	enemies.append(EnemySpawn.new("GUREL", GUREL_ALT, 0.15, 1))
	enemies.append(EnemySpawn.new("KLE", KLE, 0.15, 1))
	enemies.append(EnemySpawn.new("KLE", KLE_ALT, 0.15, 1))
func phase_ten():
	print("PHASE 01 - !")
